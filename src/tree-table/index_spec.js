...
describe('primeng-tree-table-schematic', () => {
    ...
    it('should create files and add them to module', () => {
        const tree = runner.runSchematic('primengTreeTable', Object.assign({}, options), testing_2.createTestApp());
    ...
    it('should add imports to module', () => {
        const tree = runner.runSchematic('primengTreeable', Object.assign({}, options), testing_2.createTestApp());
        const moduleContent = test_1.getFileContent(tree, '/src/app/app.module.ts');
