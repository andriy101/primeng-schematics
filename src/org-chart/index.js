...
function addComponentModulesToModule(options) {
    return (host) => {
        ...
        if (modulePath) {
            ast_1.addModuleImportToModule(host, modulePath, 'OrganizationChartModule', 'primeng/organizationchart');
            ast_1.addModuleImportToModule(host, modulePath, 'GrowlModule', 'primeng/growl');
        }
        return host;
    };
}
